...
tmpafter=$(mktemp)
find ./libiocage/ -name \*.py -exec flake8 --ignore=E203 {} + | grep -v "./libiocage//__init__.py" > ${tmpafter}
...
tmpbefore=$(mktemp)
find ./libiocage/ -name \*.py -exec flake8 --ignore=E203 {} + | grep -v "./libiocage//__init__.py" > ${tmpbefore}
